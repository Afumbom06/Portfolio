...
export function ImageWithFallback(props: any) {
  ...
  // Ensure images are lazy-loaded and decoded asynchronously to reduce main-thread work on mobile
  return didError ? (
    <div
    ...
    >
      <div className="flex items-center justify-center w-full h-full">
        <img src={ERROR_IMG_SRC} alt="Error loading image" loading={loading} decoding={decoding} data-original-url={src} {...rest} />
      </div>
    </div>
  ) : (
